...
import Pages.ADO_TC_37351;

public class ADO_TC_37351_Test {
  ...
  @Test
  public void ADO_TC_37351() throws Exception {
	  test= extent.createTest("Update Item Verification and Validations");
		test.log(Status.INFO, "ADO_TC_37351 Test Case Started");
		ADO_TC_37351 at= new ADO_TC_37351();
		at.Update_Item();
		test.log(Status.INFO, "ADO_TC_37351 Test Case Completed and Passed");
	}
	@AfterTest
